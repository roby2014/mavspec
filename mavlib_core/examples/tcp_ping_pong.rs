...
fn listen<R: Read>(reader: R, whoami: String, n_iter: usize) -> mavlib_core::errors::Result<()> {
...
fn client(address: String, whoami: String, n_iter: usize) -> mavlib_core::errors::Result<String> {
...
fn handle_stream(
    ...
    thread::spawn(move || -> mavlib_core::errors::Result<()> { listen(reader, recv_name, n_iter) });
    // Send heartbeats
...
fn server(address: String, tx: mpsc::Sender<mavlib_core::errors::Result<()>>, n_iter: usize) {
...
fn start_server(address: String, n_iter: usize) -> mavlib_core::errors::Result<()> {

...
//! using [MAVCodeGen](https://gitlab.com/mavka/libs/mavcodegen) or by enabling built-in [dialect features](#dialects).
//!
//! ### Receive
//!
...
//! use mavlib_core::{Frame, Receiver};
...
//!   abstractions generated by [MAVCodeGen](https://gitlab.com/mavka/libs/mavcodegen).
